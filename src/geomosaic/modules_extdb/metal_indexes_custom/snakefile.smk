...
rule metal_indexes_custom_table:
    params:
    ...
    output:
        rmi_rpi_folder = directory(expand("{rmi_rpi_indexes_extdb_folder}", rmi_rpi_indexes_extdb_folder=config["EXT_DB"]["rmi_rpi_indexes"])),
    ...
    shell:
        ...
        cp {params.user_table} {output.rmi_rpi_folder}
