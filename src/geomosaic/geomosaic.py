...
def main():
    ...
    prerun_optional.add_argument('--conda_frontend', default='conda', type=str, choices=['conda', 'mamba'], help="Specify which conda frontend Snakemake should use to install environments (conda or mamba). Default: conda.")
