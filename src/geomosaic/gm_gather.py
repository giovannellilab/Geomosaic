...
from geomosaic.gathering.gather_metal_rmi_rpi_indexes import gather_metal_indexes_rb
...
def geo_gather(args):
    ...
    additional_info = {
        "assembly_hmmsearch_output_folder": assembly_hmm_outfolder,
        "mags_hmmsearch_output_folder": mags_hmm_outfolder
    }
...
def gather_functions():
    return {
        ...
        "rmi_rpi_indexes": gather_metal_indexes_rb,
