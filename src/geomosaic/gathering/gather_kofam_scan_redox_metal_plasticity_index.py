...
def gather_kofam_scan_redox_metal_plasticity_index(all_samples, geomosaic_wdir, output_base_folder, additional_info):
    pckg = "kofam_scan_redox_metal_plasticity_index"
